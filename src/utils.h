...
/** This bool gets set by @ref darknet_fatal_error() when a thread determines Darknet must exit.  This prevents Darknet
 * from logging any more (misleading) errors that happen on additional threads.
 */
extern bool darknet_must_exit;
