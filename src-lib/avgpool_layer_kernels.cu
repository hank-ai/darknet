...
extern "C" void forward_avgpool_layer_gpu(Darknet::Layer & l, network_state state)
{
	TAT(TATPARMS);
...
extern "C" void backward_avgpool_layer_gpu(Darknet::Layer & l, network_state state)
{
	TAT(TATPARMS);
