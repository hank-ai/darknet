...
void update_convolutional_layer_gpu(layer l, int batch, float learning_rate, float momentum, float decay, float loss_scale);
...
void forward_convolutional_layer(const layer l, network_state state);
